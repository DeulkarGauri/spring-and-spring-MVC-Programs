...
public class EmployeeController {
	...
	public ModelAndView ExceptionHandler() { // to see exception handling happen or not then change data type of age integer to int
		Map<String, String> data = new HashMap<String, String>();
		data.put("error", " Opps!!!!!!!!!!!! something goes wrong ..... please check it.");
